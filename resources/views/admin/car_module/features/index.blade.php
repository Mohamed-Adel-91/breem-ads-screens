                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="table-container">
                            @php
                                $extraFilters = view('admin.car_module.features.partials.filters', [
                                    'filters' => $filters,
                                ])->render();
                            @endphp
                            @include('admin.partials.filter-form', [
                                'action' => route('admin.features.index'),
                                'resetUrl' => route('admin.features.index'),
                                'exportUrl' => '#',
                                'filters' => $filters,
                                    ...
                                    <div class="col-md-2 d-flex justify-content-end p-0">
                                        <div class="col-md-6 d-flex justify-content-end  p-0">
                                            <button type="text" class="btn btn-primary" style="margin-top: 20px;">
                                                <a href="{{ route('admin.features.create') }}" style="color: #fff;">
                                                    <i class="icon-plus-circle mr-1"></i>New</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            @include('admin.partials.results-summary', ['data' => $data, 'label' => 'المزايا'])
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-actions">
                                                            ...
                                                            <form method="POST" id="delete_form_{{ $item->id }}" class="d-inline delete_form" action="{{ route('admin.features.destroy', ['feature' => $item->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            <tr>
                                                <td colspan="11" class="text-center">
                                                    <div class="alert alert-danger">
                                                        لا توجد سجلات للمواصفات مطابقة للمعايير.
                                                    </div>
                                                </td>
                                            </tr>
                                        @endif
