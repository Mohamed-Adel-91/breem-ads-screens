                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="table-container">
                            @include('admin.partials.filter-form', [
                                'action' => route('admin.car_exteriors.index'),
                                'resetUrl' => route('admin.car_exteriors.index'),
                                'exportUrl' => '',
                                'filters' => $filters,
                                'extraFilters' => '',
                            ])
                                    ...
                                    <div class="col-md-2 d-flex justify-content-end p-0">
                                        <div class="col-md-6 d-flex justify-content-end  p-0">
                                            <button type="text" class="btn btn-primary" style="margin-top: 20px;">
                                                <a href="{{ route('admin.car_exteriors.create') }}" style="color: #fff;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-actions">
                                                            <a href="{{ route('admin.car_exteriors.edit', $item->id) }}" class="icon bg-info" data-toggle="tooltip" data-placement="top" title="Edit Row">
                                                                <i class="icon-edit"></i>
                                                            </a>
                                                            <form method="POST" id="delete_form_{{ $item->id }}" class="d-inline delete_form" action="{{ route('admin.car_exteriors.destroy', ['car_exterior' => $item->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
