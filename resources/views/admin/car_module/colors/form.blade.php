                        ...
                        <div class="col-12">
                            <div class="card h-100">
                                <div class="card-header">
                                    <div class="card-title">{{ isset($data) ? __('admin.forms.edit') : __('admin.forms.create') }} {{ __('admin.forms.color_entity') }}
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row gutters">
                                        ...
                                        @include('admin.layouts.components.media-upload', [
                                            ...
                                            'previewPath' => isset($data) && $data->image ? 'upload/colors/' . $data->id . '/' . $data->image : null,
                                        ])
                                    </div>
                                </div>
