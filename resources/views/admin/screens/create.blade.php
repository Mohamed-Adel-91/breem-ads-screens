<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">{{ __('Create screen') }}</h1>
                <p class="mt-1 text-sm text-gray-500">{{ __('Register a new display device and link it to a location.') }}</p>
            </div>
