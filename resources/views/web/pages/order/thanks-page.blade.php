    ...
    <main>
        <section class=" thanks_section">
            <div class="flex flex-wrap">
                <div class="w-full sm:w-1/2 text-center py-10 flex items-center" style="background: #B1BAC3;">
                    <div class="w-full md:w-1/2 mx-4 md:mx-auto md:order-1 order-2">
                        <h3 class="trim_title">
                            <span class="trim_title_num">4</span>
                            <span class="">امتلك</span>
                        </h3>

                        <h3 class="trim_title">مبروك لقد حجزت الان {{ $order->term->model->brand->name }} {{ $order->term->model->name }} {{ $order->term->term_name }}</h3>

                        <p class="mb-2 text-lg">الرقم الحجز الخاص بك هو</p>
                ...
                <div class="w-full sm:w-1/2 items-center justify-center md:order-2 order-1">
                    <span class="block h-full">
                        <img src="{{ $firstColorImage ?? $order->term->model->image_path }}" alt="" class="w-full h-full object-cover" />
                    </span>
                </div>
            </div>
        </section>
