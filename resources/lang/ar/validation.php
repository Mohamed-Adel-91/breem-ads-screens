...
return [
    ...
    */
    ...
    'custom' => [
        '*.item_description_en.required' => 'الوصف بالإنجليزية مطلوب.',
        '*.item_description_ar.required' => 'الوصف بالعربية مطلوب.',
        '*.unit.required' => 'الوحدة مطلوبة.',
        '*.unit_price.required' => 'سعر الوحدة مطلوب.',
        '*.price_expiration_date.required' => 'تاريخ انتهاء السعر مطلوب.',
        '*.min_qty_to_supply.required' => 'الحد الأدنى للكمية مطلوب.',
        '*.delivery.required' => 'تفاصيل التسليم مطلوبة.',
        '*.warranty.required' => 'تفاصيل الضمان مطلوبة.',
        '*.warranty_by.required' => 'مقدم الضمان مطلوب.',
