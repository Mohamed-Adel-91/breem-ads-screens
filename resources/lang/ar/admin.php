...
return [
    ...
    'cms' => [
        ...
        'ui' => [
            ...
            'item_activation_defect' => 'تُخزَّن حالة تفعيل العنصر داخل محتوى العنصر، وهي لا تُخفي العنصر حاليًا على الموقع العام.',
            'section_unreachable' => 'هذه الشاشة غير مرتبطة بأي مسار في لوحة التحكم حاليًا، وهي محفوظة للصيانة منخفضة المستوى لأقسام الصفحات.',
            'section_upload_defect' => 'تُرسَل الملفات وبيانات القسم من هذه الشاشة بطريقة PATCH، وهي طريقة لا يحلّل معها PHP بيانات النماذج متعددة الأجزاء.',
