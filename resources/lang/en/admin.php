...
return [
    ...
    'cms' => [
        ...
        'ui' => [
            ...
            'item_activation_defect' => 'Item activation is stored inside the item content and does not currently hide the item on the public website.',
            'section_unreachable' => 'This screen is not linked from any admin route today. It is kept for low-level maintenance of page sections.',
            'section_upload_defect' => 'Files and section data submitted from this screen are sent with the HTTP PATCH method, which PHP does not parse for multipart form data.',
