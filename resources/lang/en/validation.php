...
return [
    ...
    */
    ...
    'custom' => [
        '*.item_description_en.required' => 'The item description in English is required.',
        '*.item_description_ar.required' => 'The item description in Arabic is required.',
        '*.unit.required' => 'The unit is required.',
        '*.unit_price.required' => 'The unit price is required.',
        '*.price_expiration_date.required' => 'The price expiration date is required.',
        '*.min_qty_to_supply.required' => 'The minimum quantity to supply is required.',
        '*.delivery.required' => 'The delivery details are required.',
        '*.warranty.required' => 'The warranty details are required.',
        '*.warranty_by.required' => 'The warranty provider is required.',
        '*.photos.required' => 'The photos are required.',
    ],
